export const CREATE_INVENTORY_TABLE = `create table inventory (
...
export const ADD_INVENTORY = `insert into inventory (inventory_id, item_brand, item_name, item_balance, item_image, item_price)
